...
<tool name="read_file">
 ...
 <read path=".zen/.agent/schemas/README.schema.md" required="true" error="on not found" />
</tool>
...
Update or create documentation as specified in the instruction above, following Zen conventions.
