...
<tool name="read_file">
 ...
 <read path=".zen/.agent/schemas/ALIGN_REPORT.schema.md" required="true" error="on not found" />
</tool>
...
<file path=".zen/align/ALIGN-{x}-WITH-{y}-{nnn}.md" />
