...
<tool name="read_file">
 ...
 <read path=".zen/.agent/schemas/DESIGN.schema.md" optional="true" />
...
Update or create the task list document(s) as specified in the instruction above, following Zen conventions.
