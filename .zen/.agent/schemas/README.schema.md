...
[![npm version](https://img.shields.io/npm/v/zen-cli.svg)](https://www.npmjs.com/package/zen-cli)
...
zen generate --features typescript,testing
...
```bash
zen generate --features strict,verbose --remove-features legacy
```
