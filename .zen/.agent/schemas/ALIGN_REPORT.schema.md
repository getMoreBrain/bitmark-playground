<schema target-files=".zen/alignment/ALIGN-{x}-WITH-{y}-{nnn}.md">
...
- [ ] 1. CRITICAL [CERTAIN] MISSING
  ...
  TARGET: (not found)
  ISSUE: Design component declares IMPLEMENTS: WKS-1_AC-1, but no code file contains @zen-component: WKS-WorkspaceConfig with @zen-impl: WKS-1_AC-1.
